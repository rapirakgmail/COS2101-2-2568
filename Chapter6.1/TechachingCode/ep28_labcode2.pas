...
function FindAccount(n:Integer ; id:Integer ; var accList: myIntArray): Integer;
var 
  x:Integer;
//  bfound:boolean;
begin
...
procedure depositAcc( n:Integer; var accList: myIntArray);
var
    id: Integer;
    x:Integer;
    deposit: real;
...
procedure withdrawAcc(n:Integer; var accList: myIntArray);
var
    id: Integer;
    x:Integer;
 withdraw : real;
...
procedure newAcc(var accList: myIntArray ; var n:Integer);
var
    id: Integer;
    name: string;
    addr: string;
...
begin
    ...
    repeat
      ...
      2:
        begin
          depositAcc(n, accList);
        end;
      3:
        begin
          withdrawAcc(n, accList);
        end;
      4:
        begin
          writeln('4.Comput Interest');
